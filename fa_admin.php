...
<head>
	...
	<title>Finance_admin - Dashboard</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Finace_</span>Admin</a>
				<a class="navbar-brand" href="index.php"><span>home</span></a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user">
								<use xlink:href="#stroked-male-user"></use>
							</svg> Finance_admin <span class="caret"></span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="#"><svg class="glyph stroked-star">
					...
					</svg> View Pending Payments</a></li>
			<li><a href="#"><svg class="glyph stroked-calendar">
						<use xlink:href="#stroked-calendar"></use>
					</svg> View Current Payments</a></li>
			<li><a href="#"><svg class="glyph stroked calendar">
						<use xlink:href="#stroked-calendar"></use>
